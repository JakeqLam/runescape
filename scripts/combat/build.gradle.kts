...
runemate {
    ...
    manifests {
        create("GPT Combat") {
            mainClass = "com.runemate.party.combat.GPTCombat"
            tagline = "My simple Combat Trainer!"
            description = "A simple Combat Trainer that does it all"
            version = "1.0.0"
            internalId = "example-Combat"
