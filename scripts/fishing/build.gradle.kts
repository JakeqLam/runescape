...
runemate {
    ...
    manifests {
        create("Simple Fisher") {
            mainClass = "com.runemate.party.fishing.SimpleFisher"
            tagline = "My simple Fisher Trainer!"
            description = "A simple Fisher Trainer that does it all"
            version = "1.0.0"
            internalId = "example-Fishing"
