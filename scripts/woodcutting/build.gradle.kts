...
runemate {
    ...
    manifests {
        create("GPT Woodcutter") {
            mainClass = "com.runemate.party.woodcutting.Woodcutter"
            tagline = "A woodcutter that woodcuts and banks"
            description = "A woodcutter that cuts and banks, with anti-ban"
            version = "1.0.0"
